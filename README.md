...
## Auto-enforce the cap via Home Assistant
...
→ **[examples/home-assistant/grid_charge_cap.yaml](examples/home-assistant/)** — REST sensor + automation that monitors Powerwall SOC and turns off grid-charging when it crosses the cap.
